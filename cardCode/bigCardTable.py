...
counters on it damages Oiled Stone, put a blaze counter on Oiled Stone." ]
    ...
    "Forest Fire": {
        "cost": "2PP",
        "type": "Aether",
        "effects": [ "When there are no comrades in either territory, sacrifice Forest Fire.", "When Forest Fire enters your territory or \
a comrade is terminated, put a blaze counter on Forest Fire, then deal damage to target comrade equal to the number of blaze counters on Forest Fire." ]
    ...
    "Trebuchet": {
        "cost": "4M",
        "type": "Aether",
        "effects": [ "You cannot activate an effect of Trebuchet unless a comrade named \"Wheel Runner\" is in your territory.", "Sacrifice a \
        Stone comrade: Trebuchet deals damage equal to its vitality to target comrade. If the sacrificed creature had blaze counters on it, Trebuchet \
        also deals damage equal to its strength to the target comrade's controller."
